...
node(privateCloud,cloudOp,[ubuntu, mySQL, python], 128, [gpu]).
...
node(accesspoint,ispOp,[ubuntu, mySQL, python], 4, [lightshub, videocamera]).
    0.95::anti_tampering(accesspoint).
...
node(edgenode,edgeOp,[ubuntu, python], 8, [gpu, lightshub, videocamera]).
